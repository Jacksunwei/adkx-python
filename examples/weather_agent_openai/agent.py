...
"""Example of a weather Agent using OpenAI.

This example demonstrates:
1. Using OpenAI models (GPT-4, GPT-4o, etc.) with ADK agents
...
showing how easy it is to switch between Gemini and OpenAI.
...
# 3. Create the OpenAI LLM instance
# API key is automatically loaded from OPENAI_API_KEY environment variable
openai_llm = OpenAI(
    model="gpt-4o",  # Change this to your preferred model (gpt-4, gpt-4-turbo, etc.)
    # If you need to set the API key explicitly instead of using env var:
    # api_key="sk-your-api-key-here",
    # If you're using an OpenAI organization:
    # organization="org-your-org-id",
)

# 4. Create an agent with the OpenAI LLM and tool
root_agent = Agent(
    name="weather_assistant",
    model=openai_llm,  # Pass the OpenAI instance directly
    instruction="""
