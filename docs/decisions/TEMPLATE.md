...
1. **Accepted** - Approved and being/been implemented
1. **Deprecated** - Decision no longer recommended but still in use
1. **Superseded** - Replaced by a newer ADR (link to it)
